  ...
  return (
    <div className="w-full min-h-screen backdrop-blur-md p-5 flex flex-col justify-evenly items-center space-y-10">
      <motion.div
        ...
        className="w-full h-full flex flex-col justify-evenly items-center text-justify space-y-12 sm:w-5/6"
      >
        <img
          src={Influencerimg}
          alt="Influencerimg"
          className="w-full sm:w-5/6 rounded-3xl border-4 border-black dark:border-white"
        />
      ...
      <motion.div
        ...
        whileInView={{ x: "0%", opacity: 1 }}
        transition={{ duration: 0.4, delay: 0.5 }}
        className="flex flex-col justify-evenly items-center text-justify space-y-12 sm:w-5/6"
      >
        <img
          src={Editing}
          alt="Influencerimg"
