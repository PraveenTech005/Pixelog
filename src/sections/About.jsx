...
const About = () => {
  return (
    <section className="flex flex-col justify-evenly items-center w-full min-h-screen space-y-10 text-justify">
      <h1 className="text-3xl pt-10 w-5/6">About Us</h1>
      <div className="flex flex-col w-5/6 card p-5 rounded-2xl space-y-5 md:flex-row justify-evenly items-center">
        <img
          src={MediaAnimate}
          alt="Animated Media"
          className="w-5/6 md:w-4/12"
        />
        <p className="indent-5 lg:w-3/6 lg:leading-10">
      ...
      <div className="flex flex-col-reverse w-5/6 card p-5 rounded-2xl space-y-5 md:flex-row justify-evenly items-center">
        <p className="indent-5 lg:w-3/6 lg:leading-10">
