      ...
      >
        <div className="w-full min-h-svh flex flex-col justify-evenly items-center z-0 relative">
          <div className="space-y-5 title z-1 mt-50">
            <p className="sora w-6/12 text-xl">Hi 👋, We are</p>
            <div>
              <FuzzyText
                baseIntensity={0.1}
                hoverIntensity={0.4}
      ...
      >
        ...
        <div className="w-full p-10 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {services.map((item, index) => (
            <div
              key={index}
              className="bg-white/10 border-2 border-white/10 rounded-2xl h-auto stack cursor-pointer -rotate-z-5 grayscale transition duration-300 ease-in-out hover:scale-[1.02]"
            >
